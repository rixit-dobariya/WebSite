<%@ Page Title="" Language="C#" MasterPageFile="~/HDFCMasterPage.master" AutoEventWireup="true" CodeFile="NewApplication.aspx.cs" Inherits="NewApplication" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%">
        <thead>
            <tr>
                <td colspan="2">New Loan Application</td>
            </tr>
        </thead>
        <tbody>
            <tr>
